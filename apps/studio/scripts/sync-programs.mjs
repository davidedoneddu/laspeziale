...
const programs = [
  {
    ...
    excerpt: 'Molto piu di una dieta: un metodo che integra alimentazione personalizzata, analisi della composizione corporea, fitoterapia e consapevolezza.',
    order: 1,
  ...
  },
  {
    ...
    image: 'gonfiore-intestinale.jpg',
    category: 'Area clinica',
    excerpt: 'Un percorso dedicato a digestione, gonfiore e funzionalita intestinale per aiutare il tuo organismo a ritrovare regolarita e leggerezza.',
    order: 4,
  ...
  },
  {
    ...
    image: 'menopausa-premenopausa.jpg',
  ...
  },
  {
    ...
    image: 'anti-age.png',
    category: 'Anti-age',
    excerpt: 'Un percorso dedicato a mantenere energia, forza, tono muscolare e vitalita, per vivere ogni fase della vita con maggiore equilibrio.',
    order: 6,
    audience: ['Chi vuole lavorare su prevenzione e vitalita', 'Chi cerca un approccio integrato'],
    benefits: ['Prevenzione e vitalita', 'Routine alimentari sostenibili', 'Supporto antinfiammatorio'],
  },
  {
  ...
  },
  {
    ...
    benefits: ['Obiettivi realistici', 'Maggiore consapevolezza', 'Continuita nel tempo'],
  },
]
...
async function syncProgram(program) {
  ...
  const defaults = {
    ...
    faqs: [
      ...
      {_key: `online-${program.order}`, question: 'Posso seguire il percorso online?', answer: 'Quando previsto, il percorso puo essere svolto online o in studio.'},
    ],
    ctaLabel: 'Prenota una consulenza',
    ctaLink: '/contatti',
    heroPrimaryLabel: 'Scopri di piu',
...
await client
  ...
  .setIfMissing({
    ...
    heroTitle: 'I nostri programmi',
    heroText: 'Programmi personalizzati per accompagnarti con equilibrio, semplicita e profondita nel tuo cambiamento.',
    heroImage: programsHero,
    listTitle: 'Benessere integrale a Milano',
    listText: 'Scegli il percorso piu vicino alle tue esigenze e scopri come viene costruito.',
    ...
    methodText:
      'La Speziale distingue tra percorsi nutrizionali personalizzati e supporti indipendenti: cosi ogni persona puo orientarsi verso la consulenza piu adatta al proprio momento.',
